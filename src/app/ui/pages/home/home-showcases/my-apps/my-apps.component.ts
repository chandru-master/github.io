...
export class MyAppsComponent implements OnInit {
  ...
  _mApps = [
    ...
    {
     "id": "5131",
     "name": "Crash course in Data Analytics",
     "image": "assets/img/apps/master.jpg",
   ...
   {
     "id": "5132",
     "name": "Won 2nd prize in All India data science project",
     "image": "assets/img/apps/achievement.jpg",
     "link": "https://imarticus.org/",
     "tab": "Android",
     "caption": "In Mumbai -",
     "background":"#90EE90"
